...
// xxx does this do what it should? Identify is hard to drive.
// identifyForReview runs identify on a user, taking into account tracking.
...
func identifyForReview(mctx libkb.MetaContext, assertion string,
	...
	eng := engine.NewResolveThenIdentify2(mctx.G(), &keybase1.Identify2Arg{
		...
		IdentifyBehavior:      keybase1.TLFIdentifyBehavior_RESOLVE_AND_CHECK, // xxx ???
	})
